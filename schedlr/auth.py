...
def login_required(view):
    ...
    def wrapped_view(**kwargs):
        if g.user is None:
            return redirect(url_for('auth.login')) # when user not logged in, redirect to require login
        
        return view(**kwargs) # when user is logged in, return the original view
